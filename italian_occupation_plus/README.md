# Italian Occupation Plus — v0.0.20 (Yugoslavia + Albania + Bulgaria + Greece + Turkey + North Africa + Egypt + Spain + Portugal + Occitania)
...
| **IOC** | Governo militare di occupazione dell'Occitania | Midi-Pyrénées (31) | Centre-Sud (33), Limousin (25), Aquitaine (19), Pyrénées-Atlantiques (806), Midi-Pyrénées (31), Auvergne (26), Rhône (20), Languedoc (22) |
...
### 52 decisions — all free, all with map highlighting
...
│   ├── country_tags/iop_tags.txt            # ICR / ISE / IMT / IAL / IBL / IGR / ITR / INA / IEG / ISP / IPG / IOC
...
│   └── decisions/IOP_occitania.txt                # 1 founding (IOC) + provence + savoy/var + corsica
├── history/
│   ├── countries/ICR|ISE|IMT|IAL|IBL|IGR|ITR|INA|IEG|ISP|IPG|IOC*.txt       # capitals, leaders, tech
