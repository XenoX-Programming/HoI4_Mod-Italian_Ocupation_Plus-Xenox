# Italian Occupation Plus — v0.0.19 (Yugoslavia + Albania + Bulgaria + Greece + Turkey + North Africa + Egypt + Spain + Portugal)
...
### 48 decisions — all free, all with map highlighting
...
│   ├── country_tags/iop_tags.txt            # ICR / ISE / IMT / IAL / IBL / IGR / ITR / INA / IEG / ISP / IPG
...
├── history/
│   ├── countries/ICR|ISE|IMT|IAL|IBL|IGR|ITR|INA|IEG|ISP|IPG*.txt       # capitals, leaders, tech
